import com.github.wladox.testable.TestableQueueInputDStream
...
/**
  ...
  */
class StreamFilterWordCount extends FunSuite with BeforeAndAfterEach with BeforeAndAfterAll {
